...
const RulesPanel = React.lazy(() =>
	import('../rules/RulesPanel').then((m) => ({ default: m.RulesPanel })),
);
const FeedPanel = React.lazy(() =>
	import('../feed/FeedPanel').then((m) => ({ default: m.FeedPanel })),
);
const BashPanel = React.lazy(() =>
	import('../bash/BashPanel').then((m) => ({ default: m.BashPanel })),
);
const TodoPanel = React.lazy(() =>
	import('../todo/TodoPanel').then((m) => ({ default: m.TodoPanel })),
);
const FilePreviewOverlay = React.lazy(() =>
	import('../file-preview/FilePreviewOverlay').then((m) => ({ default: m.FilePreviewOverlay })),
);
const DiffViewerPanel = React.lazy(() =>
	import('../diff/DiffViewerPanel').then((m) => ({ default: m.DiffViewerPanel })),
);
